...
public class Game extends Canvas implements Runnable{
    ...
    public void render(){
        ...
        if (handler.pausenmnue){
            ...
            g.setColor(Color.black);
            g.drawString("Movement", 330, 300 + 9);

            g.setColor(Color.black);
            g.drawString("Exit Game", 330, 350 + 9);
            ...
            else if (handler.menuedotpostition == 5){
                g.setColor(Color.red);
            ...
            */
            ...
            if (handler.look_at_Movment == true && handler.countdown_for_menuedot != 0) {

                g.setColor(Color.lightGray);
                g.fillRect(350, 100, 200, 300);
                g.setColor(Color.black);
                g.drawRect(350, 100, 200, 300);

                g.setColor(Color.black);
                g.drawString("Movment: ", 360, 112 );
                g.setColor(Color.black);
                g.drawString("W - move forwart", 360, 130);
                g.setColor(Color.black);
                g.drawString("A - move leftwart", 363, 142);
